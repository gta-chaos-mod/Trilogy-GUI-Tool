    ...
    public static class EffectDatabase
    {
        ...
        public static void PopulateEffects(string game)
        {
            ...
            if (game == "san_andreas")
            {
                ...
                AddEffect(new FunctionEffect(Category.CustomEffects_Player, "Auto Collect Pickups", "PickupMagnet", "auto_collect_pickups"));
                ...
                AddEffect(new FunctionEffect(Category.CustomEffects_Vehicle, "Swap Steering Axle", "SwapSteeringAxle", "swap_steering_axle"));
